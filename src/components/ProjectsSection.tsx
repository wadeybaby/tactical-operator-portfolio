  ...
  const projects = [
    {
      ...
      codeLink: "#", // No code link
    },
    {
      id: 2,
      title: "Digital Tracking System (Iliso)",
      description: "A real-time attendance management solution built using Python, Mysql, and Google Sheets integration. This system uses NFC technology to allow employees to clock in and out seamlessly, while automatically updating a live dashboard that tracks on-site and off-site staff.",
      image: ilisoImg,
    ...
    },
    {
      ...
      description: "A flutter-based mobile application that scrapes from major South African retailers including Pick n Pay, Woolworths, Checkers, and Game/Makro. Built using Flutter and Python for scraping.",
      image: pricePulseImg,
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group bg-card border border-border rounded-2xl overflow-hidden card-hover flex flex-col h-full"
            >
              ...
              <div className="p-6 flex flex-col justify-between h-full">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    {/* CONDITIONAL RENDERING: Only show if link is not "#" */}
                    {project.demoLink !== "#" && (
                      <Button
                        variant="default"
                        size="sm"
