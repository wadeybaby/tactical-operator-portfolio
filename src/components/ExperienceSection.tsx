...
const ExperienceSection = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      type: "work",
      description: "Maintained and updated e-commerce website functionality. Gained hands-on experience with WordPress, PHP, and frontend development. Successfully implemented client requirements and troubleshot technical issues.",
